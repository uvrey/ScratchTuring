...
import TargetPane from '../components/target-pane/target-pane.jsx'
...
import globeIcon from '../components/action-menu/icon--globe.svg';
import compassIcon from '../components/action-menu/icon--compass.svg';
import mapUploadIcon from '../components/action-menu/icon--map-upload.svg';
...
class MapTab extends React.Component {
    ...
    render () {
        ...
        return (
            <Modal
                // buttons={[{
                //     title: intl.formatMessage(messages.addMap),
                //     img: mapUploadIcon,
                //     onClick: onNewSoundFromLibraryClick
                // }, {
                //     title: intl.formatMessage(messages.surpriseMap),
                //     img: compassIcon,
