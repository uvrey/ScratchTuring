...
class Runtime extends EventEmitter {
    ...
    /**
   * Event name to generate and display N posterior curves
   * @const {string}
   */
    ...
    /**
   * Event name to render tooltip updates
   * @const {string}
   */
    ...
    /**
   * Event name to render mean updates from user input (Normal dashboard)
   * @const {string}
   */
    ...
    /**
 * Event name to render stdv updates from user input (Normal dashboard)
 * @const {string}
 */
    ...
    /**
     * Event name to render updates to ground truth from user input (Normal dashboard)
     * @const {string}
     */
    ...
    /**
     * Event name to remove a model and dashboard
     * @const {string}
     */
    ...
    /**
     * Event name to update parameters of a prior distribution (Normal dashboard)
     * @const {string}
     */
    ...
    /**
   * Event name to update parameters of a ground truth distribution (Normal dashboard)
   * @const {string}
   */
