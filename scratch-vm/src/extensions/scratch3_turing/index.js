...
class TuringPPL {
    ...
    //     const distUrl = "http://127.0.0.1:8080/api/turing/v1/dist"; //TODO make relevant to project
    //     var responseCopy
    ...
    //     return fetch(distUrl, distPayload)
    //         .then(function (response) {
    //             // Clone the response so that it can be used in the catch block
    //             responseCopy = response.clone();
    //             console.log("Got response: " );
